clear;close all;
% settings
%floder应该指的是原HR的文件夹，savepath应该是指保存的路径
%folder = 'D:/gitwork/Keras-Image-Super-Resolution/data/test/trainHR/DIV2K_train_HR';
%savepath = 'D:/gitwork/Keras-Image-Super-Resolution/data/train/trainLR';
folder = 'D:/gitwork/Keras-Image-Super-Resolution/data/test/valiHR/DIV2K_valid_HR';
savepath = 'D:/gitwork/Keras-Image-Super-Resolution/data/test/validset';
size_input = 74;
%scale 
scale = 4; 
